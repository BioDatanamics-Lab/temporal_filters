...
if KSE == 1
    ...
    [taudep sgmadep taufac sgmafac E_F E_G sgmadepfac]
    ...
    figure
    hold on
    plot(tspk,DeltaS,'ob','linewidth',2);
    plot(tspk,H,'-b','linewidth',1);
    plot(tspk,Hcut,'--','Color',lightgray,'linewidth',2);
    plot(tspk,H,'-b','linewidth',1);
    %plot(tspk,H,'-b','linewidth',2);
    axis([0 300 0  1]);
    legend('\DeltaS_n','H','H_{cut}')
    set(gca,'fontsize',24);
    xlabel('t  [ms]');
elseif KSE == 2
    ...
    Xfp_vec = zeros(1,length(SpkFreqin));
    Zfp_vec = zeros(1,length(SpkFreqin));
    ...
    figure
    hold on
    plot(SpkFreqin,sgmadep./sgmafac,'ob','linewidth',2);    
    plot(SpkFreqin,sgmadep./sgmafac,'-b','linewidth',1);    
    axis([0 SpkFreqinmax 0  10]);    
    set(gca,'fontsize',24);
    xlabel('f_{spk}  [Hz]');
    ylabel('\eta = \sigma_d / \sigma_f');
    
    figure
    hold on
    plot(SpkFreqin,Xfp_vec,'ob','linewidth',2);    
    plot(SpkFreqin,Xfp_vec,'-b','linewidth',1);    
    ...
    figure
    hold on
    plot(SpkFreqin,Zfp_vec,'ob','linewidth',2);    
    plot(SpkFreqin,Zfp_vec,'-b','linewidth',1);    
    axis([0 SpkFreqinmax 0  1]);    
    set(gca,'fontsize',24);
    xlabel('f_{spk}  [Hz]');
